            ...
            $.ajax({
              ...
              success: (result) => {
                ...
                if (dataTable) {
                  ...
                  const buildingHtmlPromise = mode === "members_troops" ? this.fetchPageHtml(`https://${window.location.host}/game.php?screen=ally&mode=members_buildings&player_id=${currentPlayer.playerId}&page=${pageNumber}`) : Promise.resolve("");
